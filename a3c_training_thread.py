...
class A3CTrainingThread(object):
    def __init__(
        ...
        self.local_network = Network(ACTION_SIZE, thread_index, device)
    ...
    def _record_score(
            self, sess, summary_writer, summary_op, score_input, score, global_t):
    ...
    def process(self, sess, global_t, summary_writer, summary_op, score_input):
        ...
        if (
            ...
            print(
                "### Performance : {} STEPS in {:.0f} sec. {:.0f} STEPS/sec. {:.2f}M STEPS/hour".format(
